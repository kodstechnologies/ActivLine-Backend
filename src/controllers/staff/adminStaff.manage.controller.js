...
export const getAssignedCustomerPaymentHistory = asyncHandler(async (req, res) => {
  const result = await StaffService.getAssignedCustomerPaymentHistory(req.user, req.query || {});
